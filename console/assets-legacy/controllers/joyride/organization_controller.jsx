                ...
                steps={[
                    {
                        content: (
                            <>
                                <h3 className="mb-3">Bienvenue sur Citipo</h3>
                    ...
                    },
                    {
                        content: (
                            <>
                                <div className="mb-3">
                                    Citipo fonctionne grâce à un système de projets : un projet regroupe différentes
                                    fonctionnalités au même endroit, comme par exemple un site internet, des campagnes
                                    emails, des commandes d'imprimés, ...
                                </div>
