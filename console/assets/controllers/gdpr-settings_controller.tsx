...
export default class extends AbstractController {
    readonly globalNewsletterTarget: HTMLInputElement;
    readonly globalSmsTarget: HTMLInputElement;
    readonly globalCallsTarget: HTMLInputElement;

    readonly projectNewsletterTargets: HTMLInputElement[];
    readonly projectSmsTargets: HTMLInputElement[];
    readonly projectCallsTargets: HTMLInputElement[];
