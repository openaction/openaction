...
const reactControllers: Record<string, { default: FunctionComponent }> =
    ...
    connect() {
      ...
      element.timeout = setTimeout(() => {
        ...
        if (typeof component === "undefined") {
          throw new Error(
            'React controller "' + this.componentValue + '" does not exist',
          );
        }

        element.root = createRoot(element);
        element.root.render(
          createElement(component.default, this.propsValue, null),
        );
      }, 100);
    }
