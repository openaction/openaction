...
import ContactsList from '../../../../../react/controllers/Organization/Community/ContactsList';
...
describe('ContactsList', () => {
    ...
    it('default tag filter', async () => {
        render(<div role="container">{createControllerComponent('TagFacet')}</div>);
...
function createControllerComponent(defaultTagFilter: string | null = null) {
    return (
        <ContactsList
            search={{
            ...
            tags={{
                ...
                defaultFilter: defaultTagFilter,
            }}
            tagsNamesRegistry={[]}
            links={{
