...
final class Version20210926093159 extends AbstractMigration
{
    ...
    {
        $this->addSql('DROP SEQUENCE integrations_revue_accounts_id_seq CASCADE');
        $this->addSql('DROP TABLE integrations_revue_accounts');
    }
}
