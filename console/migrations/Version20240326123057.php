...
final class Version20240326123057 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE website_petitions (id BIGSERIAL NOT NULL, project_id BIGINT NOT NULL, slug VARCHAR(200) NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, signatures_goal INT NOT NULL, signatures_count INT NOT NULL, uuid UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, only_for_members BOOLEAN NOT NULL, page_views BIGINT NOT NULL, external_url VARCHAR(250) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE website_petitions_localized (id BIGSERIAL NOT NULL, petition_id BIGINT NOT NULL, main_image_id BIGINT DEFAULT NULL, locale VARCHAR(10) NOT NULL, title VARCHAR(200) NOT NULL, description VARCHAR(200) NOT NULL, content TEXT NOT NULL, submit_button_label VARCHAR(30) NOT NULL, optin_label VARCHAR(30) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE website_petitions_localized ADD CONSTRAINT FK_3C9C8FEFE4873418 FOREIGN KEY (main_image_id) REFERENCES uploads (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
