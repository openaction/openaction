 ...
 */
final class Version20250916212002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_3C9C8FEF5FF69B7D ON website_petitions_localized (form_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3C9C8FEF3DA5256D ON website_petitions_localized (image_id)');
        $this->addSql('COMMENT ON COLUMN website_petitions_localized.uuid IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE website_petitions_localized_petitions_localized_categories (localized_petition_id BIGINT NOT NULL, petition_category_id BIGINT NOT NULL, PRIMARY KEY(localized_petition_id, petition_category_id))');
        $this->addSql('CREATE INDEX IDX_73F58100A8F1AF90 ON website_petitions_localized_petitions_localized_categories (localized_petition_id)');
        ...
        $this->addSql('ALTER TABLE website_petitions_localized ADD CONSTRAINT FK_3C9C8FEF3DA5256D FOREIGN KEY (image_id) REFERENCES uploads (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE website_petitions_localized_petitions_localized_categories ADD CONSTRAINT FK_73F58100A8F1AF90 FOREIGN KEY (localized_petition_id) REFERENCES website_petitions_localized (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
