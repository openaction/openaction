...
class PetitionCategoryTransformer extends AbstractTransformer
{
    public function transform(PetitionCategory $category)
    {
        return [
            '_resource' => 'PetitionCategory',
            '_links' => [
                'self' => $this->createLink('api_website_petitions_categories_view', ['id' => Uid::toBase62($category->getUuid())]),
            ],
