...
use App\Cdn\UploadHandler\PrintingPreviewImageHandler;
...
class CdnUploadRequest
{
    ...
    public static function createPrintingSourceRequest(Project $project, File $file): self
    {
        return new self($file, 'printing-source', null, $project);
    }

    public static function createPrintingPreviewRequest(Project $project, File $file): self
    {
        return new self($file, 'printing-preview', PrintingPreviewImageHandler::class, $project);
    }

    public static function createPrintingBatFileRequest(File $file): self
    {
        return new self($file, 'printing-bat');
    }
