...
class TestFixtures extends AbstractFixtures
{
    ...
    /** @var PrintingOrder[] */
    private array $printingOrders = [];

    /** @var PrintingCampaign[] */
    private array $printingCampaigns = [];
    ...
    private function loadOrders()
    {
        $items = [
            ...
            // Print draft
            '1c183332-2811-43fe-89e7-795f2817d04b' => [
                'company' => 'citipo',
                'orga' => $this->orgas['cbeb774c-284c-43e3-923a-5a2388340f91'], // Acme
                'mollieId' => 'ord_1c183332',
                'action' => OrderAction::print('fbf6c9dd-ca6f-43eb-8472-331d34038939'),
                'recipient' => new OrderRecipient('Titouan', 'Galopin', 'titouan.galopin@citipo.com', 'en'),
                'amount' => 10_000_00,
            ],

            // Print draft 2
            '38889b3e-de86-4d58-884b-e0190722148f' => [
                'company' => 'citipo',
                'orga' => $this->orgas['cbeb774c-284c-43e3-923a-5a2388340f91'], // Acme
                'mollieId' => 'ord_38889b3e',
                'action' => OrderAction::print('6f5d9acf-eb9c-483d-9e24-1b32d82b8afc'),
                'recipient' => new OrderRecipient('Titouan', 'Galopin', 'titouan.galopin@citipo.com', 'en'),
                'amount' => 10_000_00,
            ],
            ...
            // Print invoiced BAT to validate
            'b5908318-cedd-4c70-9dd6-f50d221298a3' => [
                'company' => 'citipo',
                'orga' => $this->orgas['cbeb774c-284c-43e3-923a-5a2388340f91'], // Acme
                'mollieId' => 'ord_b5908318',
                'action' => OrderAction::print('502e6549-9c59-452d-993e-61bee136812a'),
                'recipient' => new OrderRecipient('Titouan', 'Galopin', 'titouan.galopin@citipo.com', 'en'),
                'amount' => 10_000_00,
                'paidAt' => new \DateTime('2021-12-28 18:44:12'),
                'invoiceNumber' => 154,
                'invoicePdf' => $this->uploads['print-invoice-bat.pdf'],
                'invoiceSentAt' => new \DateTime('2021-12-28 18:45:34'),
            ],

            // Print invoiced delivered
            '8b38f034-978e-4676-8f62-7ef465309fcc' => [
                'company' => 'citipo',
                'orga' => $this->orgas['cbeb774c-284c-43e3-923a-5a2388340f91'], // Acme
                'mollieId' => 'ord_8b38f034',
                'action' => OrderAction::print('502e6549-9c59-452d-993e-61bee136812a'),
                'recipient' => new OrderRecipient('Titouan', 'Galopin', 'titouan.galopin@citipo.com', 'en'),
                'amount' => 10_000_00,
                'paidAt' => new \DateTime('2021-12-28 18:44:12'),
                'invoiceNumber' => 155,
                'invoicePdf' => $this->uploads['print-invoice-delivered.pdf'],
                'invoiceSentAt' => new \DateTime('2021-12-28 18:45:34'),
            ],
    ...
    private function loadUploads()
    {
        $items = [
            ...
            'contact-picture.jpg' => [],
            'invoice.pdf' => [],
            'print-addressed.xlsx' => [],
            'print-invoice-delivered.pdf' => [],
            'print-invoice-bat.pdf' => [],
            'print-bat.pdf' => [],
            'print-campaign_door.pdf' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-campaign_door_preview.png' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_ballot.pdf' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_ballot_preview.png' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_poster.pdf' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_poster_preview.png' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_pledge.pdf' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
            'print-official_pledge_preview.png' => ['project' => $this->projects['2c720420-65fd-4360-9d77-731758008497']],
        ];
    ...
    private function loadPrintingOrders()
    {
        $items = [
            // Draft unaddressed no envelop no QR code
            '7e3617e3-b147-4f53-864c-1550d65ddbc4' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'deliveryMainAddressName' => 'Titouan Galopin',
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
                'deliveryMainAddressZipCode' => '75008',
                'deliveryMainAddressCity' => 'Paris',
                'deliveryMainAddressCountry' => 'FR',
                'deliveryMainAddressInstructions' => 'Floor 1',
                'deliveryPosterAddressName' => 'Preview Titouan Galopin',
                'deliveryPosterAddressStreet1' => 'Preview 49 Rue de Ponthieu',
                'deliveryPosterAddressStreet2' => 'Preview CPGT SAS',
                'deliveryPosterAddressZipCode' => '75007',
                'deliveryPosterAddressCity' => 'Preview Paris',
                'deliveryPosterAddressCountry' => 'FR',
                'deliveryPosterAddressInstructions' => 'Preview Floor 1',
                'recipientCandidate' => 'Jean Duguet',
                'recipientDepartment' => '35',
                'recipientCirconscription' => '2',
                'recipientFirstName' => 'Titouan',
                'recipientLastName' => 'Galopin',
                'recipientEmail' => 'titouan.galopin@citipo.com',
                'recipientPhone' => '0606060606',
            ],

            // Draft unaddressed no envelop no QR code subrogated
            '14d1d488-37a0-4ab8-acbd-5268109b2e4a' => [
                'project' => $this->projects['e816bcc6-0568-46d1-b0c5-917ce4810a87'],
                'deliveryMainAddressName' => 'Titouan Galopin',
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
            ...
            // Draft with addressed file to parse
            '4730f1df-b3ba-4b2b-8d08-b459888e760d' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'withEnveloping' => true,
                'deliveryAddressed' => true,
                'deliveryAddressFile' => $this->uploads['print-addressed.xlsx'],
                'deliveryAddressFileFirstLines' => [
                    ['M', 'Titouan', 'Galopin', '49 Rue de Ponthieu', '75008', 'Paris', 'FR'],
                    ['M', 'Adrien', 'Duguet', '50 Rue de Ponthieu', '75008', 'Paris', 'FR'],
                    ['M', 'Jean', 'Martin', '51 Rue de Ponthieu', '75008', 'Paris', 'FR'],
                ],
                'recipientCandidate' => 'Jean Duguet',
                'recipientDepartment' => '35',
                'recipientCirconscription' => '2',
            ...
            // Draft addressed common QR code
            'bbac36c0-afca-44b5-98cd-3db6ee8a2ea8' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'withEnveloping' => true,
                'deliveryAddressed' => true,
                'deliveryAddressList' => [
            ...
            // Draft unaddressed enveloped unique QR code
            '9557ff76-88a0-42aa-9c08-c4ce31e5e8a6' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'withEnveloping' => true,
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
                ...
                'deliveryMainAddressCountry' => 'FR',
                'deliveryMainAddressInstructions' => 'Floor 1',
                'deliveryPosterAddressName' => 'Poster Name',
                'deliveryPosterAddressStreet1' => 'Poster 49 Rue de Ponthieu',
                'deliveryPosterAddressStreet2' => 'Poster CPGT SAS',
                'deliveryPosterAddressZipCode' => '75010',
                'deliveryPosterAddressCity' => 'Poster Paris',
                'deliveryPosterAddressCountry' => 'FR',
                'deliveryPosterAddressInstructions' => 'Poster Floor 1',
                'recipientCandidate' => 'Jean Duguet',
                'recipientDepartment' => '35',
                'recipientCirconscription' => '2',
                'recipientFirstName' => 'Titouan',
            ...
            // Payment pending, unaddressed, common QR code
            'fbf6c9dd-ca6f-43eb-8472-331d34038939' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'status' => ['bat_pending' => 1, 'payment_pending' => 1],
                'order' => $this->orders['1c183332-2811-43fe-89e7-795f2817d04b'],
                'deliveryMainAddressName' => 'Titouan Galopin',
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
                'deliveryMainAddressZipCode' => '75008',
            ...
            // Payment pending, addressed, unique QR code
            '6f5d9acf-eb9c-483d-9e24-1b32d82b8afc' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'status' => ['bat_pending' => 1, 'payment_pending' => 1],
                'order' => $this->orders['38889b3e-de86-4d58-884b-e0190722148f'],
                'withEnveloping' => true,
                'deliveryAddressed' => true,
                'deliveryAddressList' => [
                    [
            ...
            // BAT to validate
            '8aa012a7-cbf5-4ca5-ab67-fcf338c7309a' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'status' => ['bat_pending' => 1, 'payment_pending' => 1],
                'order' => $this->orders['b5908318-cedd-4c70-9dd6-f50d221298a3'],
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
                'deliveryMainAddressZipCode' => '75008',
                'deliveryMainAddressCity' => 'Paris',
                'deliveryMainAddressCountry' => 'FR',
                'bat' => $this->uploads['print-bat.pdf'],
                'recipientCandidate' => 'Jean Duguet',
                'recipientDepartment' => '35',
                'recipientCirconscription' => '2',
                'recipientFirstName' => 'Titouan',
            ...
            // Delivered
            '502e6549-9c59-452d-993e-61bee136812a' => [
                'project' => $this->projects['2c720420-65fd-4360-9d77-731758008497'],
                'status' => ['production_started' => 1],
                'order' => $this->orders['8b38f034-978e-4676-8f62-7ef465309fcc'],
                'deliveryMainAddressStreet1' => '49 Rue de Ponthieu',
                'deliveryMainAddressStreet2' => 'CPGT SAS',
                'deliveryMainAddressZipCode' => '75008',
                'deliveryMainAddressCity' => 'Paris',
                'deliveryMainAddressCountry' => 'FR',
                'batValidatedAt' => new \DateTime('2022-01-9 12:34:00'),
                'printedAt' => new \DateTime('2022-01-12 12:34:00'),
                'deliveredAt' => new \DateTime('2022-01-15 12:34:00'),
            ],
        ];

        foreach ($items as $id => $data) {
            $this->em->persist($this->printingOrders[$id] = PrintingOrder::createFixture(array_merge($data, ['uuid' => $id])));
        }

        $this->em->flush();
    }

    private function loadPrintingCampaigns()
    {
        $items = [
            // Draft unaddressed no envelop no QR code
            '4dbb20d4-8c71-4f73-993a-296485abcd5d' => [
                'printingOrder' => $this->printingOrders['7e3617e3-b147-4f53-864c-1550d65ddbc4'],
                'product' => Products::PRINT_CAMPAIGN_DOOR,
                'source' => $this->uploads['print-campaign_door.pdf'],
                'preview' => $this->uploads['print-campaign_door_preview.png'],
                'quantity' => 2,
            ],

            // Draft unaddressed no envelop no QR code subrogated
            '41467805-2e4a-4801-9588-e2f9ed49ea2f' => [
                'printingOrder' => $this->printingOrders['14d1d488-37a0-4ab8-acbd-5268109b2e4a'],
                'product' => Products::PRINT_OFFICIAL_PLEDGE,
                'source' => $this->uploads['print-official_pledge.pdf'],
                'preview' => $this->uploads['print-official_pledge_preview.png'],
                'quantity' => 35_682,
            ],

            // Draft with addressed file to parse
            'f97c43f5-2af2-4885-a794-e7b5230a6368' => [
                'printingOrder' => $this->printingOrders['4730f1df-b3ba-4b2b-8d08-b459888e760d'],
                'product' => Products::PRINT_OFFICIAL_BALLOT,
            ],

            '1d73e638-650a-4c38-8f01-16e0bb0fb361' => [
                'printingOrder' => $this->printingOrders['4730f1df-b3ba-4b2b-8d08-b459888e760d'],
                'product' => Products::PRINT_OFFICIAL_POSTER,
            ],

            // Draft addressed common QR code
            '67cb7459-eb96-406f-9668-1ca5c81bd598' => [
                'printingOrder' => $this->printingOrders['bbac36c0-afca-44b5-98cd-3db6ee8a2ea8'],
                'product' => Products::PRINT_CAMPAIGN_BOOKLET_4,
                'source' => $this->uploads['print-official_poster.pdf'],
                'preview' => $this->uploads['print-official_poster_preview.png'],
                'quantity' => 3,
            ],

            // Draft unaddressed enveloped unique QR code
            'a826aa93-f863-4060-9adf-5f8c19e6edac' => [
                'printingOrder' => $this->printingOrders['9557ff76-88a0-42aa-9c08-c4ce31e5e8a6'],
                'product' => Products::PRINT_OFFICIAL_POSTER,
                'source' => $this->uploads['print-official_ballot.pdf'],
                'preview' => $this->uploads['print-official_ballot_preview.png'],
                'quantity' => 4,
            ],

            // Payment pending, unaddressed, common QR code
            'b759f152-c80d-4767-ad49-0d02b909b950' => [
                'printingOrder' => $this->printingOrders['fbf6c9dd-ca6f-43eb-8472-331d34038939'],
                'status' => ['bat_pending' => 1],
                'product' => Products::PRINT_CAMPAIGN_DOOR,
                'quantity' => 1000,
            ],

            // Payment pending, addressed, unique QR code
            '3fd8a374-1c81-4f31-bfc3-1e9527dd7a6c' => [
                'printingOrder' => $this->printingOrders['6f5d9acf-eb9c-483d-9e24-1b32d82b8afc'],
                'status' => ['bat_pending' => 1],
                'product' => Products::PRINT_CAMPAIGN_DOOR,
                'quantity' => 3,
            ],
            ...
            // BAT to validate
            'e28316fb-a32d-4fd5-885f-7d9f925e1c94' => [
                'printingOrder' => $this->printingOrders['8aa012a7-cbf5-4ca5-ab67-fcf338c7309a'],
                'status' => ['bat_received' => 1],
                'product' => Products::PRINT_CAMPAIGN_DOOR,
                'quantity' => 2000,
                'bat' => $this->uploads['print-bat.pdf'],
            ],
            ...
            // Delivered
            'af1aa4d3-add8-443b-a4ef-30ac74ee3ccc' => [
                'printingOrder' => $this->printingOrders['502e6549-9c59-452d-993e-61bee136812a'],
                'status' => ['delivered' => 1],
                'product' => Products::PRINT_CAMPAIGN_DOOR,
                'quantity' => 3000,
                'batValidatedAt' => new \DateTime('2022-01-09 12:34:00'),
                'printedAt' => new \DateTime('2022-01-12 12:34:00'),
                'deliveredAt' => new \DateTime('2022-01-15 12:34:00'),
            ],
        ];
        ...
        foreach ($items as $id => $data) {
            $this->em->persist($this->printingCampaigns[$id] = PrintingCampaign::createFixture(array_merge($data, ['uuid' => $id])));
        }
