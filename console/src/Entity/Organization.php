...
class Organization
{
    ...
    #[ORM\Column(type: 'boolean')]
    private bool $printSubrogated = false;

    #[ORM\Column(length: 150, nullable: true)]
    private ?string $printParty = null;
    ...
    public static function createTrialing(string $name, string $plan, self $duplicate = null): self
    {
        ...
        if ($duplicate) {
            ...
            $self->printParty = $duplicate->printParty;
            $self->printSubrogated = $duplicate->printSubrogated;
        }
    ...
    public static function createFixture(array $data): self
    {
        ...
        $self->printSubrogated = $data['printSubrogated'] ?? false;
        $self->printParty = $data['printParty'] ?? false;
    ...
    public function getPrintParty(): ?string
    {
        return $this->printParty;
    }

    public function setPrintParty(?string $printParty)
    {
        $this->printParty = $printParty;
    }

    public function isPrintSubrogated(): bool
    {
        return $this->printSubrogated;
    }

    public function setPrintSubrogated(bool $printSubrogated)
    {
        $this->printSubrogated = $printSubrogated;
    }
