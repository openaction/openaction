...
#[ORM\Entity(repositoryClass: TrombinoscopeCategoryRepository::class)]
#[ORM\Table(name: 'website_trombinoscope_categories')]
class TrombinoscopeCategory
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: TrombinoscopePerson::class, mappedBy: 'categories')]
