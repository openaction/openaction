...
final class Permissions
{
    ...
    // Print
    public const COMMUNITY_PRINTING_MANAGE_DRAFTS = 'community_printing_manage_drafts';
    public const COMMUNITY_PRINTING_ORDER = 'community_printing_order';
    public const COMMUNITY_PRINTING_STATS = 'community_printing_stats';
    ...
    public static function allForProjects()
    {
        return [
            ...
            self::COMMUNITY_PRINTING_MANAGE_DRAFTS,
            self::COMMUNITY_PRINTING_ORDER,
            self::COMMUNITY_PRINTING_STATS,
