    ...
    private function doPopulateIndexingTableForFilter(string $filter, array $params): void
    {
        $selectQuery = '
            SELECT
                ...
                -- Profile
                c.profile_formal_title, c.profile_first_name, c.profile_middle_name, c.profile_last_name,
                c.profile_birthdate,
                ...
                c.profile_gender, c.profile_nationality, c.profile_company, c.profile_job_title,

                -- Address
                c.address_street_line1, c.address_street_line2, c.address_zip_code,
                c.address_city, UPPER(country.code) AS address_country,
