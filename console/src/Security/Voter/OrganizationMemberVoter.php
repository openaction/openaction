...
class OrganizationMemberVoter extends Voter
{
        ...
        switch ($permission) {
            ...
            case Permissions::COMMUNITY_SEE_MODULE:
                return $project->isModuleEnabled(Features::MODULE_COMMUNITY) && (
                    ...
                    || $this->voteOnAttribute(Permissions::COMMUNITY_PRINTING_MANAGE_DRAFTS, $project, $token)
                    || $this->voteOnAttribute(Permissions::COMMUNITY_PRINTING_ORDER, $project, $token)
                    || $this->voteOnAttribute(Permissions::COMMUNITY_PRINTING_STATS, $project, $token)
    ...
    private function isToolEnabled(Project $project, string $permission): bool
    {
        switch ($permission) {
            ...
            case Permissions::COMMUNITY_PRINTING_MANAGE_DRAFTS:
            case Permissions::COMMUNITY_PRINTING_ORDER:
            case Permissions::COMMUNITY_PRINTING_STATS:
                return $project->isModuleEnabled(Features::MODULE_COMMUNITY)
                    && $project->isToolEnabled(Features::TOOL_COMMUNITY_PRINTING);
        }
