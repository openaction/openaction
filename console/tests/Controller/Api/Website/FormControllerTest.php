...
class FormControllerTest extends ApiTestCase
{
    ...
    public function testViewNotFound()
    {
        ...
        $this->apiRequest($client, 'GET', '/api/website/forms/invalid', self::DEFAULT_TOKEN, 404);
        $this->apiRequest($client, 'GET', '/api/website/forms/7rnedzqzqk0hv5ktdm3a1m', self::DEFAULT_TOKEN, 404);
    }
    ...
    public function testAnswerNewContactFullMapping()
    {
        ...
        $this->apiRequest($client, 'POST', '/api/website/forms/4x0UjLrg8RJYHWTY9ZyCWs/answer', self::ACME_TOKEN, 201, Json::encode([
            'fields' => [
                '25',
                'Employed',
                'Male',
