...
class TrombinoscopeCategoryControllerTest extends ApiTestCase
{
    ...
    public function testViewNotFound()
    {
        ...
        $this->apiRequest($client, 'GET', '/api/website/trombinoscope-categories/invalid', self::DEFAULT_TOKEN, 404);
        $this->apiRequest($client, 'GET', '/api/website/trombinoscope-categories/7rnedzqzqk0hv5ktdm3a1m', self::DEFAULT_TOKEN, 404);
    }
}
