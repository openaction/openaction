...
class ProjectsControllerTest extends WebTestCase
{
    public function testList()
    {
        ...
        $this->assertSelectorExists('[data-global] .projects-item:contains("1 members")');
        ...
        $this->assertSelectorExists('[data-local] .projects-item:contains("1 members")');
    ...
    public function testCreateProjectBatch(): void
    {
        ...
        $this->assertSame(
            ['website_pages', 'website_posts', 'website_documents', 'website_events', 'website_forms', 'website_newsletter', 'website_trombinoscope', 'website_manifesto', 'community_contacts', 'community_emailing', 'community_texting', 'community_phoning', 'community_printing'],
            $project1->getTools()
        );
