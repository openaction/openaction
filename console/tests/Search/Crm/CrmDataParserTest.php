...
use App\Search\Crm\CrmDataParser;
use App\Tests\KernelTestCase;
use App\Util\Json;

class CrmDataParserTest extends KernelTestCase
{
    public function testCreateNdJsonBatches()
    {
        self::bootKernel();

        /** @var CrmDataParser $dataParser */
        $dataParser = self::getContainer()->get(CrmDataParser::class);

        $batches = $dataParser->createNdJsonBatchesFromFile(__DIR__.'/../../Fixtures/search/indexing_crm.txt');
        ...
        // Check first line
        $file = fopen($batches['219025aa-7fe2-4385-ad8f-31f386720d10'][0], 'rb');
        $line = fgets($file);
