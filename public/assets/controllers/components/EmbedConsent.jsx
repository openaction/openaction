...
export const EmbedConsent = (props) => {
    if (window.disableEmbedConsent === true && props.forceEmbedConsent === false) {
        Cookies.set('embedded-consent-'+props.type, '1');
    }

    const parsedUrl = new URL(props.url, 'https://example.com');
    const [hasConsent, setHasConsent] = useState('1' === Cookies.get('embedded-consent-'+props.type));
    ...
    const cancelConsent = () => {
        Cookies.set('embedded-consent-'+props.type, '0');
