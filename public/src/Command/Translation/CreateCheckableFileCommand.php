...
{
    protected static $defaultName = 'translation:create-checkable-file';
    ...
    {
        $this
            ->setDescription('Create a file that can be checked using a standard text typos checker.')
            ->addArgument('locale', InputArgument::REQUIRED, 'Locale to generate the file for')
        ;
    }
